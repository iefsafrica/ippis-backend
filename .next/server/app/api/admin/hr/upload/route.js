...
(() => {
var exports = {};
exports.id = "app/api/admin/hr/upload/route";
exports.ids = ["app/api/admin/hr/upload/route"];
exports.modules = {

/***/ "(rsc)/./app/api/admin/hr/upload/route.ts":
/*!******************************************!*\
  !*** ./app/api/admin/hr/upload/route.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   OPTIONS: () => (/* binding */ OPTIONS),\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var _vercel_blob__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @vercel/blob */ \"(rsc)/./node_modules/@vercel/blob/dist/index.js\");\n/* harmony import */ var _lib_cors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../lib/cors */ \"(rsc)/./lib/cors.ts\");\n\n\nasync function OPTIONS(req) {\n    return (0,_lib_cors__WEBPACK_IMPORTED_MODULE_0__.handleOptions)(req);\n}\nasync function POST(req) {\n    try {\n        const formData = await req.formData();\n        const file = formData.get(\"file\");\n        if (!file) {\n            return (0,_lib_cors__WEBPACK_IMPORTED_MODULE_0__.withCors)(req, {\n                success: false,\n                error: \"No file provided\"\n            }, 400);\n        }\n        const blob = await (0,_vercel_blob__WEBPACK_IMPORTED_MODULE_1__.put)(`employee-warnings/${Date.now()}-${file.name}`, file, {\n            access: \"public\"\n        });\n        return (0,_lib_cors__WEBPACK_IMPORTED_MODULE_0__.withCors)(req, {\n            success: true,\n            url: blob.url,\n            pathname: blob.pathname\n        });\n    } catch (error) {\n        console.error(\"Blob upload error:\", error);\n        return (0,_lib_cors__WEBPACK_IMPORTED_MODULE_0__.withCors)(req, {\n            success: false,\n            error: \"File upload failed\"\n        }, 500);\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/admin/hr/upload/route.ts\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   handleOptions: () => (/* binding */ handleOptions),\n/* harmony export */   withCors: () => (/* binding */ withCors)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n\nconst allowedOrigins = [\n    \"http://localhost:3000\",\n    \"https://ippis-frontend.vercel.app\"\n];\n// ✅ Generate CORS headers dynamically\nfunction getCorsHeaders(origin) {\n    return {\n        \"Access-Control-Allow-Origin\": origin || \"\",\n        \"Access-Control-Allow-Methods\": \"GET, POST, PUT, DELETE, PATCH, OPTIONS\",\n        \"Access-Control-Allow-Headers\": \"Content-Type, Authorization\",\n        \"Access-Control-Allow-Credentials\": \"true\"\n    };\n}\n// ✅ Handle normal JSON response with CORS\nfunction withCors(req, json, status = 200) {\n    const origin = req.headers.get(\"origin\") || \"\";\n    const allowed = allowedOrigins.includes(origin) ? origin : \"\";\n    return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(json, {\n        status,\n        headers: getCorsHeaders(allowed)\n    });\n}\n// ✅ Handle preflight OPTIONS request\nfunction handleOptions(req) {\n    const origin = req.headers.get(\"origin\") || \"\";\n    const allowed = allowedOrigins.includes(origin) ? origin : \"\";\n    return new next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse(null, {\n        status: 204,\n        headers: getCorsHeaders(allowed)\n    });\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./lib/cors.ts\n");

/***/ }),

/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fadmin%2Fhr%2Fupload%2Froute&page=%2Fapi%2Fadmin%2Fhr%2Fupload%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fadmin%2Fhr%2Fupload%2Froute.ts&appDir=C%3A%5CUsers%5CPC%5Cippis-backend%5Capp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=C%3A%5CUsers%5CPC%5Cippis-backend&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
